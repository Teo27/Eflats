        ...
        <div class="container-fluid">
            ...
            <div class="navbar-header pull-left">
                ...
                <ul class="nav navbar-nav collapse navbar-collapse" id="myNavbar">
                    <li class="active"><a href="MainPageLandlord.aspx"><b>Home</b></a></li>
        ...
        <table style="margin: 100px auto;width: 60%">
            ...
            <tr>
                <td class="auto-style47">
                          ...
                          <asp:GridView ID="GridViewAllFlats"  BorderWidth="1px" onrowcommand="GridView1_RowCommand" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Id"  ForeColor="#9f4e3e" GridLines="None" Width="100%" HeaderStyle-CssClass="HeaderStyle"  >
                              ...
                              <Columns>
                                  ...
                                  <asp:BoundField DataField="AvailableFrom" HeaderText="AvailableFrom" > 
                                  </asp:BoundField>

                                   <asp:ButtonField ButtonType="Button" Text="View" CommandName="View" ControlStyle-CssClass="btn btn-sm button1" />  
                         

                                  <asp:TemplateField>
                                    <ItemTemplate>
                                         <asp:Button ID="ButtonSend"  runat="server" Text="Send" CommandName="Send" CommandArgument='<%# Container.DataItemIndex %>' class="btn btn-sm button1"/>
                                    </ItemTemplate>                
                                 </asp:TemplateField>                                                        

        ...
        <div class="container-fluid">
            ...
            <div class="navbar-header pull-left">
                ...
                <ul class="nav navbar-nav collapse navbar-collapse" id="myNavbar">
                    <li class="active"><a href="Register.aspx"><b>Login/Register</b></a></li>
            ...
            <div class="navbar-header pull-right">
                ...
                <ul class="dropdown-menu">
                    ...
                    <h1 class="auto-style78">
                        <asp:Label ID="LabelRegister" runat="server" Font-Size="20pt" ForeColor="#9f4e3e" Text="REGISTER" Font-Bold="True"></asp:Label>
                                </h1>
                            </td>
                            <td class="auto-style87" colspan="2">
                    <asp:Label ID="LabelLogIn" runat="server" Font-Size="20pt" Text="LOG IN" Font-Bold="True" ForeColor="#9f4e3e"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <asp:TextBox ID="TextBoxPasswordLogin" runat="server" TextMode="Password" Width="95%" ></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                    <asp:Button ID="ButtonLogin" ValidationGroup='valGroup2' runat="server" Text="Login" OnClick="ButtonLogin_Click" class="btn btn-sm button1"/>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <asp:RequiredFieldValidator ValidationGroup='valGroup2' ID="RequiredFieldValidatorPassword" runat="server" ControlToValidate="TextBoxPasswordLogin" ErrorMessage="Please enter your password" ForeColor="Red"></asp:RequiredFieldValidator>
                        ...
                        <tr>
                            <td class="auto-style72" colspan="2">
                                <asp:Button ID="ButtonRegister" ValidationGroup='valGroup1' runat="server" OnClick="ButtonRegister_Click" Text="Register" class="btn btn-sm button1" />
                                <asp:Button ID="ButtonClear" runat="server" OnClick="ButtonClear_Click" Text="Clear" ValidationGroup='valGroup3' class="btn btn-sm button1"/>
                            </td>
                            <td class="auto-style72" colspan="2">

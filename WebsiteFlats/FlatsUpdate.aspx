    ...
    <form id="form1" runat="server">
      ...
      <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <table style="margin: 100px auto">
            ...
            <SelectedDayStyle BackColor="#9f4e3e" ForeColor="#ffffde" ></SelectedDayStyle>
          
            <OtherMonthDayStyle ForeColor="#787777" BorderColor="#f4f4da"></OtherMonthDayStyle>
            <TitleStyle BackColor="#9f4e3e" ForeColor="#ffffde"></TitleStyle>
            ...
            <tr>
                ...
                <td class="auto-style64" colspan="3">
                    <asp:TextBox ID="TextBoxDescription" runat="server" Height="161px" MaxLength="500" TextMode="MultiLine" Width="275px" style = "resize:none"></asp:TextBox>
                </td>
                <td class="auto-style64" colspan="2">
                    &nbsp;</td>
                <td class="auto-style52">
                    <asp:Label ID="LabelStatusUpdated" runat="server" Visible="False"></asp:Label>
                    <asp:Button ID="ButtonReopen" runat="server" OnClick="ButtonReopen_Click" Text="Reopen appartment" class="btn btn-sm button1"/>
                    </td>
            </tr>
            <tr>
                ...
                <td class="auto-style73">
                    <asp:Label ID="LabelUpdated" runat="server" Visible="False" ForeColor="Black"></asp:Label>
                    <br />
                    <asp:Button ID="ButtonUpdate" ValidationGroup = "UpdateFlat" runat="server" OnClick="ButtonUpdate_Click" Text="Update" class="btn btn-sm button1"/>
                </td>
                <td class="auto-style73">
                    &nbsp;</td>

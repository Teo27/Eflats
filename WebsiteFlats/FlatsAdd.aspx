            ...
            <TitleStyle BackColor="#9f4e3e" ForeColor="#ffffde"></TitleStyle>
                        ...
                        <tr>
                            ...
                            <td class="auto-style56">
                                ...
                                <br />
                                <asp:Button ID="ButtonAddFlat"  ValidationGroup='valGroup1' runat="server" OnClick="ButtonAddFlat_Click" Text="Add flat" CausesValidation="true" class="btn btn-sm button1"/>
                                <asp:Button ID="ButtonClear" runat="server" OnClick="ButtonClear_Click" Text="Clear" class="btn btn-sm button1" />
                            </td>
